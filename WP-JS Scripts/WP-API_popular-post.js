...
function getData() {
  var url = "/wp-json/wp_query/args/?_embed&meta_key=popular_posts&orderby=meta_value_num&per_page=10";
  var loaded = document.getElementById("loaded");
  var loading = document.getElementById("loading");

  if(countPopular >= 1) {
    var pagination = "&page=" + (countPopular+1);
    var pag_dest = url + pagination;
  } else {
    var pag_dest = url;
  }
